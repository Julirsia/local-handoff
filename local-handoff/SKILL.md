...
3. Create a compact spec first.
   - Prefer writing one JSON spec with `task_name`, `repo`, `objective`, `context`, `allowed_paths`, `forbidden_paths`, `criteria`, `boundaries`, `validation_commands`, `worker_steps`, and optional `lanes`.
